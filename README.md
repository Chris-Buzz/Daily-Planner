...
1. Clone the repository:
   ```bash
   git clone https://github.com/chris-buzz/Daily-Planner.git
   ```
...
2. Add tasks by entering the task name and selecting the time.
3. Edit or delete tasks as your schedule changes.
4. Your tasks are saved automatically in your browser's local storage.
